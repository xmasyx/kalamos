...
struct OnboardingView: View {
    ...
    private var languageStep: some View {
        question(t("In che lingua vuoi dettare?", "Which language do you dictate in?",
                 ...
                 t("Scegline una anche se ne parli più d’una: indicarla è più preciso che lasciarla indovinare a ogni frase.",
            ...
            grid([
                ...
                (2, "English", ""),
                (3, "Français", ""),
                (0, t("Automatico", "Detect it automatically", "Automatique"),
                    t("se cambi lingua spesso", "if you switch languages all day",
    ...
    private var triggerKeyStep: some View {
        question(t("Quale tasto avvia la dettatura?", "Which key starts dictation?",
            ...
            grid([
                // The key NAMES stay in English on purpose: that is what is printed
                // on the keyboard, and translating them would send someone hunting
                // for a "Comando destro" key that does not exist.
                (0x36, "Right Command",
                ...
                (0x3F, "Fn / Globe", t("se non l’hai rimappato", "unless it is remapped",
    ...
    private var triggerModeStep: some View {
        question(t("Come vuoi attivare la dettatura?", "How do you want to use it?",
            ...
            grid([
                (0, t("Tieni premuto", "Hold to talk", "Maintenir"),
                    t("un tocco singolo non fa niente", "a tap does nothing", "un appui ne fait rien")),
    ...
    private var cleanupStep: some View {
        question(t("Vuoi che sistemi quello che dici?", "Should it tidy up what you say?",
            ...
            grid([
                (1, t("Sì, con il modello", "Yes, use the model", "Oui, utiliser le modèle"),
    ...
    private var memoryStep: some View {
        question(t("Quando deve liberare la memoria?", "When should it give the memory back?",
    ...
    private var permissionsStep: some View {
        question(t("Due permessi e sei a posto", "Two permissions, and it works",
                   "Deux autorisations, et c'est prêt"),
                 t("Li concede macOS, non Kalamos. Senza il secondo il tasto non fa proprio niente, ed è il motivo per cui quasi tutti pensano che l’app sia rotta.",
            ...
            VStack(alignment: .leading, spacing: 9) {
                ...
                Text(t("L’interruttore può metterci un attimo a fare effetto.",
    ...
    private func grid(_ items: [(Int, String, String)],
        ...
        // Three choices in a two-column grid leave an orphan tile sitting alone in
        // the second row, which reads as a layout accident. An odd count gets a
        // single full-width column instead, where three rows look deliberate.
        let columns = items.count == 3
